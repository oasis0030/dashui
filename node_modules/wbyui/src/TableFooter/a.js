...
var WBYTableFooter = function (_React$Component) {
    ...
    function WBYTableFooter() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WBYTableFooter.__proto__ || Object.getPrototypeOf(WBYTableFooter)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            selectedRowKeys: [],
            indeterminate: false,
            checkAll: false
